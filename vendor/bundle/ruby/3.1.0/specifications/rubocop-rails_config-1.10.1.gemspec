# -*- encoding: utf-8 -*-
# stub: rubocop-rails_config 1.10.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<rubocop>.freeze, [">= 1.29.0"])
    s.add_runtime_dependency(%q<rubocop-ast>.freeze, [">= 1.0.1"])
    s.add_runtime_dependency(%q<rubocop-minitest>.freeze, ["~> 0.15"])
    ...
    s.add_dependency(%q<rubocop>.freeze, [">= 1.29.0"])
